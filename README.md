...
```jsx
import React from "react";
import { Iconly } from "react-native-iconly";
...
MIT [jrgarciadev](https://github.com/jrgarciadev) and [otaviomad](https://github.com/otaviomad) and [Manohar Kakumani](https://github.com/manoharkakumani)
